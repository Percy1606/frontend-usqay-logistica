...
const VentasTable = ({ filtros })=>{
    ...
    const handleDelete = (venta)=>{
        if (window.confirm(`¿Deseas eliminar la venta ${venta.idVentaServicio}?`)) {
...
_s(VentasTable, "mZAKh5cN/AHtfzmIEgI6+YytTDE=", false, function() {
    return [
...
//# sourceMappingURL=src_6a49a029._.js.map